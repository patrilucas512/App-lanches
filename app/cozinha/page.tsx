...
export default async function KitchenPage() {
  ...
  const [{ data: tickets }, { data: tableOrders }, { data: publicOrders }, { data: sessions }, { data: tables }, { data: tableItems }, { data: publicItems }, { data: serviceMode }, { data: directPrinter }] = await Promise.all([
