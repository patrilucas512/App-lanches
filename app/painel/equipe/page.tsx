...
export default async function TeamPage() {
  ...
  const [{ data: members }, { data: waiters }, { data: kitchen }, { data: ownProfile }, { data: sessions }, { data: tableOrders }, { data: payments }, { data: serviceMode }, { data: customRoles }] = await Promise.all([
