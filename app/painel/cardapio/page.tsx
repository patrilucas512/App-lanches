...
export default async function CatalogPage() {
  ...
  const [{ data: products }, { data: qrSettings }, { data: store }, { data: scans }, { data: qrOrders }, { data: finishedEvents }] = await Promise.all([
